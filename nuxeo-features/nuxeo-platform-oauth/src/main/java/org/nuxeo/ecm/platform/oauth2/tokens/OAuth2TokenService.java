...
public interface OAuth2TokenService {
    ...
    /**
     * Gets the oAuth2 tokens for a given type.
     ** 
    ...
    /**
     * Finds the oAuth2 tokens that match the given {@code query}. To be retrieved a token should match the
     * {@code query} anywhere in the string value of the fields {@link NuxeoOAuth2Token#KEY_NUXEO_LOGIN},
